...
knife user create assumes you want Open Source Server 11 user creation.
knife user create for Open Source Server 11 is being deprecated.
Open Source Server 11 user commands now live under the knife opc_user namespace.
For backwards compatibility, we will make this request in the Open Source Server 11 format.
If you are not using an Open Source Chef Server 11 install, please read knife user create --help for proper usage.
EOF
      end
